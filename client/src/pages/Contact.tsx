...
export function Contact() {
  ...
  const title = siteAssets.seoTitles?.contact || "Contact - Metal Gates Festival";
  const description = siteAssets.seoDescriptions?.contact || "Contact Metal Gates Festival organizers.";
