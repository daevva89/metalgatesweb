...
router.post('/', auth, async (req, res) => {
  ...
  console.log('POST /api/lineup - Request body received:', JSON.stringify(req.body, null, 2));
  console.log('POST /api/lineup - Request body type:', typeof req.body);
  console.log('POST /api/lineup - Request body keys:', Object.keys(req.body || {}));

  try {
    const { name, country, image, biography, spotifyEmbed, facebook, instagram, youtube } = req.body;
...
router.put('/:id', auth, async (req, res) => {
  ...
  console.log('PUT /api/lineup/:id - Request body received:', JSON.stringify(req.body, null, 2));
  ...
  try {
    ...
    console.log('PUT /api/lineup/:id - Update data:', {
      ...updateData,
      image: updateData.image ? `base64 data (${updateData.image.length} chars)` : 'no image',
...
router.delete('/:id', auth, async (req, res) => {
  ...
  try {
    ...
    console.log('DELETE /api/lineup/:id - Band deleted successfully:', band.name);
    res.json({
      success: true,
      data: { band },
